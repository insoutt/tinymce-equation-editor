...
var ButtonsTransformer_1 = require("./ButtonsTransformer");
var setup = function (editor, url) {
    ...
    editor.addCommand('mathquill-window', function (data) {
        ...
        var buttonBar = new ButtonsTransformer_1.default(btnBar).transform();
        for (var name in groups) {
            ...
            var transformGroup = buttonGroup.map(function (group) {
                ...
                var buttons = new ButtonsTransformer_1.default(group.buttons).transform();
                return {
                    name: group.name,
                    buttons: buttons,
                };
