...
var setup = function (editor, url) {
    var settings = editor.settings.equation_editor_config;
    ...
    if (typeof settings.url === 'undefined') {
        ...
        throw new Error("'url' property must be a string in equation_editor_config");
    }
    // origin
    if (typeof settings.origin === 'undefined') {
        ...
        throw new Error("'origin' property must be a string in equation_editor_config");
    }
    // title
    if (typeof settings.title === 'undefined') {
        ...
        throw new Error("'title' property must be a string in equation_editor_config");
    }
    // space_after_content
    if (typeof settings.space_after_content === 'undefined') {
        ...
        throw new Error("'space_after_content' property must be a string in equation_editor_config");
    }
    // btn_cancel_text
    if (typeof settings.btn_cancel_text === 'undefined') {
        ...
        throw new Error("'btn_cancel_text' property must be a string in equation_editor_config");
    }
    // btn_ok_text
    if (typeof settings.btn_ok_text === 'undefined') {
        ...
        throw new Error("'btn_ok_text' property must be a string in equation_editor_config");
    }
    var groups = editor.settings.equation_editor_button_groups;
    var btnBar = editor.settings.equation_editor_button_bar;
    var groupName = editor.settings.equation_editor_group;
    var htmlLatex = '';
            ...
            onMessage: function (instance, message) {
                switch (message.mceAction) {
                    ...
                    case 'equation-mounted':
                        sendParams(settings, btnBar, groups, groupName, data.latex);
                        break;
                }
            },
        });
    });
    editor.addCommand('equation-insert', function (data) {
        if (!data) {
            return;
        }
...
function sendParams(settings, btnBar, groups, groupName, latex) {
    var iframe = document.querySelector("iframe[src='" + settings.url + "']");
