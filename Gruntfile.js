...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/tinymce-mathquill-plugin/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/tinymce-mathquill-plugin/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
        ...
        files: [
          {
            cwd: 'src/text',
            src: ['license.txt'],
            dest: 'dist/tinymce-mathquill-plugin',
            expand: true
          },
          { src: ['changelog.txt'], dest: 'dist/tinymce-mathquill-plugin', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/tinymce-mathquill-plugin/version.txt', BUILD_VERSION);
  });
